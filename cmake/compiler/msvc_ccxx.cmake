...
set(CHEVRON_MSVC_VERSION_MIN 1940 CACHE STRING "Minimum MSVC compiler version")

# Confirm supported MSVC compiler version
if(MSVC_VERSION VERSION_LESS ${CHEVRON_MSVC_VERSION_MIN})
...
add_library(CHEVRON_msvc_cxx_features INTERFACE)
# C++ compiler diagnostics configuration target
add_library(CHEVRON_msvc_cxx_warnings INTERFACE)
# General C++ compiler configuration target
add_library(CHEVRON_msvc_cxx_options INTERFACE)

# C compiler feature configuration target
add_library(CHEVRON_msvc_c_features INTERFACE)
# C compiler diagnostics configuration target
add_library(CHEVRON_msvc_c_warnings INTERFACE)
# General C compiler configuration target
add_library(CHEVRON_msvc_c_options INTERFACE)

# C/C++ preprocessor definitions target
add_library(CHEVRON_msvc_common_defines INTERFACE)

# Set C++ standard version
target_compile_features(
    CHEVRON_msvc_cxx_features
...
add_library(CHEVRON_msvc_cxx_bundle INTERFACE)
# Complete MSVC C compiler package
add_library(CHEVRON_msvc_c_bundle INTERFACE)
...
target_link_libraries(
    CHEVRON_msvc_c_bundle
    
    INTERFACE
        CHEVRON_msvc_c_features
        CHEVRON_msvc_c_warnings
        CHEVRON_msvc_c_options
        CHEVRON_msvc_common_defines
