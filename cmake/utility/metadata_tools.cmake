...
macro(create_template_reference REF_NAME REF_KEY)
    if(REF_NAME STREQUAL "")
        message(FATAL_ERROR "No reference name provided for '${CHEVRON_${REF_KEY}}' value.")
    endif()
    
    # NOTE: 'REF_NAME' provided is prefixed with 'RESOLVED_'
    set(RESOLVED_${REF_NAME} ${CHEVRON_${REF_KEY}} CACHE STRING "Temporary" FORCE)
...
macro(set_metadata FIELD VALUE)
    ...
    set(CHEVRON_${FIELD} "${VALUE}" CACHE STRING "${ARGSS_DESCRIPTION}" FORCE)
endmacro()
